 ...
 * must have only one parameter of type Event and no return type as every
 * method call is done asynchronously.
...
public interface ServerInterface
{
   ...
   * Event parameter contains one parameter (String username).
   * Server will call continueLogin event method on client.
   */
   ...
   * Event parameter contains two parameter (String username, long hash).
   * Server will call loggedIn event method on client if successful.
   */
   ...
   * Event parameter contains one parameter (Session session).
   */
  void logout(Event event);
  
  /**
   * Sends a chat message to the public channel.
   * Event parameter contains two parameter (Session session, String message).
   */
  void sendChatMessage(Event event);
  
  /**
   * Creates a new game on the server.
   * Event parameter contains two parameter (Session session, String gameName).
   */
   ...
   * Event parameter contains two arguments (Session session, String gameName).
   */
   ...
   * Event parameter contains three arguments (Session session, int x, int y).
   */
   ...
   * Event parameter contains no arguments.
   */
